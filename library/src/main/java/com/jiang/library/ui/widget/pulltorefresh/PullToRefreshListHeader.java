package com.jiang.library.ui.widget.pulltorefresh;
...
public class PullToRefreshListHeader extends LinearLayout {
    ...
    private void initView(Context context) {
        LayoutParams lp = new LayoutParams(LayoutParams.FILL_PARENT, 0);  //初始化 布局高度为零
    ...
    /**
     * hide header when disable pull load more
     */
    public void hide() {
