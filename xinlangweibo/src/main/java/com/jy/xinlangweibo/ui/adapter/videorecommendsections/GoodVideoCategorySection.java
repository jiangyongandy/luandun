...
public class GoodVideoCategorySection extends StatelessSection {
    ...
    public GoodVideoCategorySection(Context context, ListBean videoListBean)
    {
//todo 将圆角实现用shapeDrawable 替换cardView
        super(R.layout.layout_video_category_head, R.layout.item_section_good_video);
    ...
    public RecyclerView.ViewHolder getHeaderViewHolder(View view)
    {
        ...
        return new GoodVideoCategorySection.HeaderViewHolder(view);
    }
    ...
    public void onBindHeaderViewHolder(RecyclerView.ViewHolder holder)
    {
        ...
        GoodVideoCategorySection.HeaderViewHolder headerViewHolder = (GoodVideoCategorySection.HeaderViewHolder) holder;
