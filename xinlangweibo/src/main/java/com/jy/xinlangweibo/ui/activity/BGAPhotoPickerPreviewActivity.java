...
import com.jy.xinlangweibo.ui.adapter.BGAPhotoPageAdapter;
 ...
 * 描述:图片选择预览界面
 */
public class BGAPhotoPickerPreviewActivity extends ToolbarActivity  implements View.OnClickListener,PhotoViewAttacher.OnViewTapListener {
            ...
            if (mSelectedImages.contains(currentImage)) {
                ...
                if (mMaxChooseCount == 1) {
                    ...
                    if (mMaxChooseCount == mSelectedImages.size()) {
                        ToastUtils.show(this,getString(R.string.bga_pp_toast_photo_picker_max), Toast.LENGTH_SHORT);
                    } else {
                        mSelectedImages.add(currentImage);
                        mChooseTv.setCompoundDrawablesWithIntrinsicBounds(R.drawable.bga_pp_ic_cb_checked, 0, 0, 0);
                        renderTopRightBtn();
