 ...
 */
public class CommentSupportFragment extends LazySupportFragment {
    ...
    public static CommentSupportFragment newInstance(long StatusId) {
        CommentSupportFragment fragment = new CommentSupportFragment();
    ...
    protected void initViewAndEvent(View rootView) {
        ...
        adapter = new CommentAdapter(new IItemViewCreator<CommentBean>() {
            @Override
            ...
            @Override
            public IITemView<CommentBean> newItemView(View convertView, int viewType) {
    ...
    public static class CommentItem extends ARecycleViewItemView<CommentBean> {
//        R.layout.item_comments
        ...
        @Override
        public void onBindData(View convertView, CommentBean comment, int position) {
